    ...
    <div className="px-4 ">
      <div className="py-4 flex items-center justify-between">
        <div className="relative">
          <div className="absolute w-full top-2 bottom-0 bg-[linear-gradient(to_right,#F87BFF,#FB29CF,#FFDD9B,#C2F0B1,#2FD8FE)] blur-md"></div>
          <Image
            src={logoImage}
            alt="product image"
        ...
        <nav className="gap-6 items-center hidden sm:flex">
            ...
            <button className="bg-white py-2 px-4 rounded-lg font-bold">Try it for FREE!</button>
        </nav>
      </div>
    </div>
    </div>
